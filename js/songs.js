    ...
    // "Midnight.mp3",
    {
      ...
      chart: {
        ...
        notes: [
          ...
          { type: "normal", time: 21.0, direction: "right" },
          { type: "normal", time: 22.0, direction: "left" },
          { type: "normal", time: 23.0, direction: "right" },
          { type: "normal", time: 24.0, direction: "up" },
          { type: "normal", time: 25.0, direction: "down" },
          { type: "normal", time: 26.0, direction: "left" },
          { type: "normal", time: 27.0, direction: "right" },
          { type: "normal", time: 28.0, direction: "up" },
          { type: "normal", time: 29.0, direction: "down" },
          { type: "normal", time: 30.0, direction: "left" },
          { type: "normal", time: 31.0, direction: "right" },
          { type: "normal", time: 32.0, direction: "up" },
          { type: "normal", time: 36.5, direction: "down" },
          { type: "normal", time: 37.5, direction: "left" },
          { type: "normal", time: 38.5, direction: "right" },
          { type: "normal", time: 39.5, direction: "up" },
          { type: "normal", time: 40.5, direction: "down" },
          { type: "normal", time: 41.5, direction: "left" },
          { type: "normal", time: 42.5, direction: "right" },
          { type: "normal", time: 43.5, direction: "up" },
          { type: "normal", time: 44.5, direction: "down" },
          { type: "normal", time: 45.5, direction: "left" },
          { type: "normal", time: 46.5, direction: "right" },
          { type: "normal", time: 47.5, direction: "up" },
          { type: "normal", time: 48.5, direction: "down" },
          { type: "normal", time: 53.0, direction: "left" },
          { type: "normal", time: 53.5, direction: "right" },
          { type: "normal", time: 54.0, direction: "up" },
          { type: "normal", time: 54.5, direction: "down" },
          { type: "normal", time: 55.0, direction: "left" },
          { type: "normal", time: 55.5, direction: "right" },
          { type: "normal", time: 56.0, direction: "up" },
          { type: "normal", time: 56.5, direction: "down" },
          { type: "normal", time: 57.0, direction: "left" },
          { type: "normal", time: 57.5, direction: "right" },
